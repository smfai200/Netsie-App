...
class Colors {
  ...
  static const Color planetCard = const Color(0xFF383838); //0xFF296D98
  ...
  static const Color planetLocation = const Color(0xFFFFFFFF);
  static const Color planetDistance = const Color(0xFFFFFFFF);
