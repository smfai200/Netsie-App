...
import 'package:netsieapp/Components/Category/category_screen.dart';
          ...
          child: ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              return GestureDetector(
                onTap: (){
                  print("Category Click" + images[index]["id"].toString());
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => CategoryList(images[index]["id"]),
                    ),
                  );
                },
                child: Container(
                ...
                decoration: BoxDecoration(
                 ...
                 child: ClipRRect(
                  ...
                  child: CachedNetworkImage(
                    imageUrl: API_Baseurl+"/"+images[index]["Category_Image"],
                    imageBuilder: (context, imageProvider) => Container(
                      decoration: BoxDecoration(
                        image: DecorationImage(
                            image: imageProvider,
